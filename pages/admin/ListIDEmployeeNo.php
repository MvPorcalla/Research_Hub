    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="d-flex justify-content-end">
                <form id="den-search-form" class="d-flex w-100">
                    <div class="input-group">
                        <input class="form-control rounded-pill" type="search" id="denQuery" placeholder="Search" aria-label="Search" autocomplete='off'>
